...
&nbsp;<a href="<?php echo admin_url("post.php?post={$selected_page_id}&action=edit"); ?>" target="_blank" class="button"><?php _e('Edit', 'memberpress'); ?></a>
  ...
  public static function payment_currency_code_dropdown($field_name, $code) {
    $codes = MeprHooks::apply_filters('mepr-currency-codes', array('USD', 'AUD', 'BGN', 'BRL', 'BWP', 'CAD', 'CHF', 'COP', 'DKK', 'EUR', 'GBP', 'HKD', 'HUF', 'HUN', 'IDR', 'ILS', 'INR', 'JOD', 'JPY', 'KES', 'MXN', 'MYR', 'NOK', 'NZD', 'PEN', 'PLN', 'RON', 'RUB', 'SAR', 'SEK', 'SGD', 'THB', 'TRY', 'TWN', 'ZAR'));
    $field_value = isset($_POST[$field_name])?$_POST[$field_name]:null;
  ...
  public static function payment_language_code_dropdown($field_name, $code) {
    $codes = MeprHooks::apply_filters('mepr-language-codes', array('US', 'AR', 'AU', 'BG', 'BR', 'CH', 'CN', 'CO', 'DE', 'DK', 'EN', 'ES', 'FI', 'FR', 'GB', 'HE', 'HU', 'ID', 'IT', 'JP', 'MS', 'MX', 'NL', 'NO', 'PE', 'PL', 'PT', 'RO', 'RU', 'SE', 'SK', 'SR', 'SW', 'TH', 'TN', 'TR', 'TW', 'ZA'));
    $field_value = isset($_POST[$field_name])?$_POST[$field_name]:null;
