    ...
    <div class="mepr-account-row-actions">
      <?php if( $subscription->status != MeprSubscription::$pending_str and
        ...
        <?php if(($grp = $product->group()) && count($grp->products('ids')) > 1): //Can't upgrade to no other options ?>
          <div id="mepr-upgrade-sub-<?php echo $sub_id; ?>" class="mepr-white-popup mfp-hide">
            <center>
          ...
          <a href="#mepr-upgrade-sub-<?php echo $sub_id; ?>" class="mepr-open-upgrade-popup mepr-account-row-action mepr-account-upgrade"><?php echo $upgrade_label; ?></a>
